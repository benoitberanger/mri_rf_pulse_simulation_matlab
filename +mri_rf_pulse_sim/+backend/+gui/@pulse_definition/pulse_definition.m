classdef pulse_definition < mri_rf_pulse_sim.backend.base_class
    ...
    methods (Access = public)
        ...
        function opengui(self, use_onefig)
            ...
            pos_uipanel_selection = [0.00 0.70 0.30 0.30];
            pos_uipanel_settings  = [0.30 0.70 0.70 0.30];
            pos_uipanel_plot      = [0.00 0.00 1.00 0.70];

            handles.uipanel_plot = uipanel(container,...
                'Title','Plot',...
                'Units','Normalized',...
                'Position',pos_uipanel_plot,...
                'BackgroundColor',fig_col.figureBG);

            handles.uipanel_selection = uipanel(container,...
                'Title','Selection',...
                'Units','Normalized',...
                'Position',pos_uipanel_selection,...
                'BackgroundColor',fig_col.figureBG);

            handles.uipanel_settings = uipanel(container,...
                'Title','Settings',...
                'Units','Normalized',...
                'Position',pos_uipanel_settings,...
                'BackgroundColor',fig_col.figureBG);
