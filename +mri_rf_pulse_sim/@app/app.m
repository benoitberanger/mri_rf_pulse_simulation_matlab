classdef app < handle
    ...
    methods (Access = public)
        ...
        function plot(self)
            ...
            % plot Mxyz
            set(self.simulation_results.line_Mup  ,'XData', [time(1) time(end)] * 1e3, 'YData', [+1 +1]);
            set(self.simulation_results.line_Mmid ,'XData', [time(1) time(end)] * 1e3, 'YData', [ 0  0]);
            set(self.simulation_results.line_Mdown,'XData', [time(1) time(end)] * 1e3, 'YData', [-1 -1]);
            ...
            % plot slice profile
            dz = dZ.vect * dZ.scale;
            set(self.simulation_results.line_Sup  ,'XData', [dz(1) dz(end)], 'YData', [+1 +1]);
            set(self.simulation_results.line_Smid ,'XData', [dz(1) dz(end)], 'YData', [ 0  0]);
            set(self.simulation_results.line_Sdown,'XData', [dz(1) dz(end)], 'YData', [-1 -1]);
